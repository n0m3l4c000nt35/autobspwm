# Generated by Powerlevel10k configuration wizard on 2024-07-25 at 17:54 -03.
...
() {
  ...
  # Available sources:
  #
  # - shell   `asdf current` says "set by ASDF_${TOOL}_VERSION envialias ll='lsd -lh --group-dirs=first'
